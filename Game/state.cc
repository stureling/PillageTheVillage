...
//SWITCH
void Engine::switchMenu(sf::RenderWindow &window, int &stateNum) const
...
void Engine::switchGO(sf::RenderWindow &window, int &stateNum, unsigned const &total_points) const
...
void Engine::switchWin(sf::RenderWindow &window, int &stateNum, unsigned const &total_points) const
